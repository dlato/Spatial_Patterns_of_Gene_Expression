setwd("C:/Users/synch/Documents/COG/R_Code_Bass_7Jun17/")
path="C:/Users/Daniella/Documents/Sinorhizobium2015/COG/R_Code_Bass_7Jun17/"
...
chrom_datafile <- "C:/Users/synch/Documents/COG/R_Code_Bass_7Jun17/Bacillus_subtilis_168_COG_category_and_positions_multiple_COGs_dealt_with.txt"
...
len_of_genome <- 2200000 #rounded up to closest 10,000 so that all of the points are included
...
p_bar_top <- ggplot(freq_dat, aes(x = chunk_pos, y = V1)) + 
  ...
  ggtitle(expression(paste(italic("B.subtilis"), " Chromosome")))+
