setwd("C:/Users/synch/Documents/COG/R_Code_Ecol_6Jun17/")
path="C:/Users/Daniella/Documents/Sinorhizobium2015/COG/R_Code_Ecol_6Jun17/"
...
chrom_datafile <- "C:/Users/synch/Documents/COG/R_Code_Ecol_6Jun17/Ecoli_COG_category_and_positions_multiple_COGs_dealt_with.txt"
...
len_of_genome <- 2900000 #rounded up to closest 10,000 so that all of the points are included
...
pdf("ecoli_chrom_COG_bargraph_and_hist_30Jan20.pdf")
grid.arrange(p_bar_top, legend, p_stacked_bar, layout_matrix = lay, widths=c(4,1), heights=c(1.5, 3.5)) 
#             top="italic(E.coli) Chromosome")
#             top=expression(paste(italic("E.coli"), " Chromosome")))
