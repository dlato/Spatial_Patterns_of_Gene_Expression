set.seed(1738)
setwd("/home/dlato/Documents/GoldingSummer14/COG_info_17Jan17/Sino/Chrom/")
path="/home/dlato/Documents/GoldingSummer14/COG_info_17Jan17/Sino/Chrom/"
...
#require("ggplot2")
#library(reshape2)
#library(plyr)#has to come before plyr oterwise it causes problems.
#library(dplyr)
#require(sandwich)
#require(msm)
...
chrom_datafile <- "/home/dlato/Documents/GoldingSummer14/COG_info_17Jan17/Sino/Chrom/Sino_chrom_COG_binary_data.csv"
