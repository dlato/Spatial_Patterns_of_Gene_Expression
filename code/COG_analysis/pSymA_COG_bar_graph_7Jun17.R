setwd("C:/Users/synch/Documents/COG/R_Code_pSymA_7Jun17/")
path="C:/Users/Daniella/Documents/Sinorhizobium2015/COG/R_Code_pSymA_7Jun17/"
...
chrom_datafile <- "C:/Users/synch/Documents/COG/R_Code_pSymA_7Jun17/Smel_1021_pSymA_COG_category_and_positions_multiple_COGs_dealt_with.txt"
...
max(data_chrom_ordered$midpoint)

rows_to_split_dat <- vector() #empty vec  to hold the rows that split the dat into 10kb chunks
len_of_genome <- 700000 #rounded up to closest 10,000 so that all of the points are included
